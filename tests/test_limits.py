...
def test_limits():
    ...
    assert(autofig.gcf().axes[0].x.lim == (-5,10))
    assert(autofig.gcf().axes[0].y.lim == (-5,10))
...
def test_padding():
    ...
    assert(autofig.gcf().axes[0].x.lim == (-6.5,11.5))
    assert(autofig.gcf().axes[0].y.lim == (-6.5,11.5))
