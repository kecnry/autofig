...
autofig.reset()
autofig.plot(x=x, y=y, c=c, cmap='afmhot', marker='s', size=6, ls='none', show=True)
...
autofig.reset()
autofig.plot(x=x, y=y, c=c, cmap='rainbow', marker='s', size=10, ls='solid', show=True)

print("multiple color scales")
autofig.reset()
autofig.plot(x=x, y=+2*x, c=+2*x, clabel='+2x', cmap='cool', marker='s', size=6, ls='none')
